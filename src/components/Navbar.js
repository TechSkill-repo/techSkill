...
import logo from "../assets/techpedia.png";
...
function Navbar() {
  return (
    <>
      <header className="fixed bg-black opacity-80 w-screen py-5 px-10 z-50">
        ...
        <div className="flex justify-between md:hidden w-full h-full p-1">
          ...
          <div className="bg-orange-500 font-semibold px-4 py-1.5 text-center rounded-md hover:text-hiadingColor duration-100 transition-all ease-in-out cursor-pointer">
            Join Now
          </div>
        </div>
      </header>
