  ...
  return (
    <div className="w-full h-fill  relative">
      <div className="w-full lg:h-screen h-full relative">
        ...
        <div className='w-full  h-full bg-[url("https://omninos.com/wp-content/uploads/2021/01/mobile-app-development-for-startup-owners.jpeg")] bg-cover bg-center  '>
          <div className="px-16   relative z-40">
            ...
            >
              <button className="bg-orange-500 lg:text-[18px] mt-5 text-[12px] font-extrabold px-6 py-4 shadow text-center rounded-md hover:bg-orange-200 hover:text-black duration-100 hover:transition-all hover:ease-in-out cursor-pointer text-gray-100 leading-tight tracking-wide mb-10 lg:mb-0">
      ...
      <div className="max-w-[85%] m-auto shadow-xl my-20 p-5">
        <h1 className="lg:text-xl text-lg text-center font-bold p-2">
