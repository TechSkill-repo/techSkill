...
function Python() {
  return (
    <div className="w-full h-[110vh]  relative">
      ...
      <div className=' w-full h-full bg-[url("https://wallpaperaccess.com/full/796849.jpg")]'>
        <div className="px-16 top-1/2 -translate-y-1/2 relative z-40">
          <h1 className="lg:text-6xl text-center lg:text-left text-4xl font-sans text-gray-50 font-extrabold leading-snug tracking-wider capitalize">
            Python Devlopment <br />
            From <span className="text-orange-500 ">0 to Hero🔥 </span>
          </h1>
